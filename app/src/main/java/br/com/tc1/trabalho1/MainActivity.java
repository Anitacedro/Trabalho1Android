...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener goToDisplina2Listener = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            ...
            Disciplina dc4  = new Disciplina(1004,7000, "Bioinformática");
            Disciplina dc5  = new Disciplina(1005,7000, "Optativa1");

            ArrayList<Disciplina> dcs = new ArrayList<>(asList(dc1,dc2,dc3));

            Intent i = new Intent(MainActivity.this, RecebeListaDeObjetosActivity.class);
